...
namespace ScoreTracking.App.Migrations
{
    ...
    [Migration("20230802101518_AddPasswordToUser")]
            ...
            modelBuilder.Entity("ScoreTracking.App.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 8, 2, 10, 15, 18, 741, DateTimeKind.Unspecified).AddTicks(3519), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "Test1@gmail.com",
                            FirstName = "Robert",
                            LastName = "Lara",
                            Phone = "+21600000001",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 8, 2, 10, 15, 18, 741, DateTimeKind.Unspecified).AddTicks(3529), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 8, 2, 10, 15, 18, 741, DateTimeKind.Unspecified).AddTicks(3534), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "Test2@gmail.com",
                            FirstName = "John",
                            LastName = "Doe",
                            Phone = "+21600000002",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 8, 2, 10, 15, 18, 741, DateTimeKind.Unspecified).AddTicks(3535), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
