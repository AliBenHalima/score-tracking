...
namespace ScoreTracking.App.Migrations
{
    ...
    [Migration("20230721175107_AddNumberToRound")]
    partial class AddNumberToRound
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ScoreTracking.App.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2023, 7, 21, 17, 51, 7, 779, DateTimeKind.Unspecified).AddTicks(1024), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "Test1@gmail.com",
                            FirstName = "Robert",
                            LastName = "Lara",
                            Phone = "+21600000001",
                            Updated = new DateTimeOffset(new DateTime(2023, 7, 21, 17, 51, 7, 779, DateTimeKind.Unspecified).AddTicks(1037), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTimeOffset(new DateTime(2023, 7, 21, 17, 51, 7, 779, DateTimeKind.Unspecified).AddTicks(1043), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "Test2@gmail.com",
                            FirstName = "John",
                            LastName = "Doe",
                            Phone = "+21600000002",
                            Updated = new DateTimeOffset(new DateTime(2023, 7, 21, 17, 51, 7, 779, DateTimeKind.Unspecified).AddTicks(1044), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
